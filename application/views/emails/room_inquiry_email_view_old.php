                ...
                <table cellpadding="0" cellspacing="0" class="force-full-width">
                  <tr>
                   <td height="60" valign="top" class="header-cell">
                      <img width="196" height="60" src="<?php echo base_url().$portal_logo; ?>" alt="logo">
                    ...
                    <td valign="top" class="body-cell">
                      <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                        <tr>
                          ...
                          We would like you to know that one of your Room is viewed and inquired by a customer !<br> To cancel the inquiry please <a href="#">click here.</a>
                          </td>
                        </tr>
                        <tr>
                          <td>
                  ...
                  <tr>
                    <td valign="top" class="footer-cell">
                      <?php echo $portal_name; ?><br>
                      an <?php echo $portal_name; ?>, INC company
                    </td>
                  </tr>
                </table>
              </td>
